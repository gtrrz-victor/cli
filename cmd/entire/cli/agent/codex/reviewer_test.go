...
func TestCodexReviewer_ArgvShape(t *testing.T) {
	...
	// Expect: codex exec --skip-git-repo-check --dangerously-bypass-approvals-and-sandbox -
	want := []string{wantCodexAgentName, "exec", "--skip-git-repo-check", "--dangerously-bypass-approvals-and-sandbox", "-"}
